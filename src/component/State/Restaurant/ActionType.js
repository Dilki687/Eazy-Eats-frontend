...
export const GET_ALL_RESTAURANTS_FAILURE = "GET_ALL_RESTAURANTS_REQUEST";
...
export const DELETE_RESTAURANT_FAILURE = "DELETE_RESTAURANT_REQUEST";
...
export const CREATE_CATEGORY_FAILURE = "CREATE_CATEGORY_REQUEST";
